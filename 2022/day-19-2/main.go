...
func solveProblem(fileName string) int {
	...
	for i, b := range bps { 
		...
		productOfMaxNumberOfGeodes *= calculateMaxNumberOfGeodes(*b, GameState{32, 0, 0, 0, 1, 0, 0, 0}, gameStateCache,false,false,false,false) 
	} 
	return productOfMaxNumberOfGeodes
}
